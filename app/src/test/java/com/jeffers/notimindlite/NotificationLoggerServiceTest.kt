...
class NotificationLoggerServiceTest : BaseRobolectricTest() {
    ...
    @Test
    fun onNotificationPosted_suppressesSelfPackageNotifications() {
        runBlocking {
            val serviceController = Robolectric.buildService(NotificationLoggerService::class.java)
            val service = serviceController.create().get()
    ...
    @Test
    fun onNotificationPosted_suppressesBlankTitleAndContentClutter() {
        runBlocking {
            val serviceController = Robolectric.buildService(NotificationLoggerService::class.java)
            val service = serviceController.create().get()
    ...
    @Test
    fun onNotificationPosted_suppressesSystemUsbDebuggingAndChargingClutter() {
        runBlocking {
            val serviceController = Robolectric.buildService(NotificationLoggerService::class.java)
            val service = serviceController.create().get()
    ...
    @Test
    fun onNotificationPosted_suppressesMoreNotificationsSummaryClutter() {
        runBlocking {
            val serviceController = Robolectric.buildService(NotificationLoggerService::class.java)
            val service = serviceController.create().get()
